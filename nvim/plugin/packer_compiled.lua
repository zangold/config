...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/rust.vim",
  ...
  ["vim-glsl"] = {
    loaded = true,
    path = "/home/zach/.local/share/nvim/site/pack/packer/start/vim-glsl",
